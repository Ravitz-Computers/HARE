...
//   - release_candidate_1.0rc3: HTTP 403
//
// Anything not listed here is never installed, whatever the update API says
...
export const APPROVED_OPENRGB_BUILDS: PinnedArtifact[] = [];
